...
--     avg_latency NUMERIC(10, 3) DEFAULT 0.00,
--     min_latency NUMERIC(10, 3) DEFAULT 0.00,
--     max_latency NUMERIC(10, 3) DEFAULT 0.00,
--     created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
--     updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP

--     UNIQUE (client_id, service_name, endpoint, method, time_bucket)  -- iska main kaam hai aagar same client_id, service_name, endpoint, method aur time_bucket ke combination se ek record already exist karta hai toh wo update ho jayega instead of insert new record
--     aagar nhi toh new record insert ho jayega
